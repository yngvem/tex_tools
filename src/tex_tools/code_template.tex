...
\usepackage[margins=2in]{geometry}
...
\lstdefinestyle{\VAR{language}}{language=\VAR{ language },
...
\lstnewenvironment{\VAR{language}code}
{
\lstset{style=\VAR{language}}
}
{
}
...
\section{\VAR{name}}
\begin{\VAR{ language }code}
\VAR{script}
\end{\VAR{ language }code}
\clearpage
